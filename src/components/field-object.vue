<template>
  <div>
    <div v-if="schema.schema">
      <vue-form-generator :tag="schema.tag || 'div'" :schema="schema.schema" :model="value" :options="formOptions" v-on="$listeners" :class="schema.fieldClasses"></vue-form-generator>
    </div>
    <div v-else>
